...
namespace Gizmosbuy.DAL.Data
{
    public partial interface IApplicationDbContextProcedures
    {
        ...
        Task<int> spSavePurchaseAsync(int? purchaseID, string serialNo, DateTime? purchaseDate, int? categoryID, int? brandID, string model, string specifications, decimal? purchasePrice, int? quantity, decimal? upgradePrice, decimal? totalPrice, string paymentMode, string buyingLead, int? transactionBy, DateTime? transactionDate, OutputParameter<int?> result, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
